...
> - Consume only the simulator's public API
...
> - Expose only aggregated pressure signals to the world, never individual patient data
>
> The adapter SHALL NOT:
> - Inspect or mutate simulator internal state
> - Bypass public interfaces
> - Introduce non-deterministic behavior
> - Let the world engine read patient-level records
> - Allow one sentinel to observe another's output
